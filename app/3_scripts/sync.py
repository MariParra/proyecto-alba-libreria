...
def sync_system():
    ...
    try:
        ...
        # --- 5. TRIGGERS DE MAYÚSCULAS PARA LIBROS ---
        cursor.execute("""
        CREATE TRIGGER IF NOT EXISTS force_uppercase_books_insert
        AFTER INSERT ON libros BEGIN
    ...
    # -- PROCESAR E INSERTAR DATOS DE CLIENTES Y SUSCRIPCIONES --
    try:
        processed_clients = 0
